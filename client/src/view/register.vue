     ...
     <div class="col-12 content">
            <div class="col-es-6 col-xs-12">
                <div class="col-12" style="padding-bottom: 40px;">
                    <a href="index.html"><img src="../Images/logo.png" style="margin-left: -20px;" width="98" height="106"></a>
                    <router-link class="signup3 signup2" id="mSignup" to="login">Sign In</router-link>
                </div>
                ...
                <form ref="form" @submit.prevent="validate">
                    ...
                    <span class="in">Phone number</span><br>
                    <input id="num" type="text" required="required">
                    <span class="in">Email</span><br>
                    ...
                    <span class="in inx">Already have an account? <router-link class="signup3" to="login">Sign In</router-link></span><br><br>
                    <span class="in inx">Click <router-link class="signup3" to="register-business">here</router-link> to sign up as a business</span><br>
            ...
            <div class="col-es-6 imgDiv">
                ...
                <router-link class="signup3" to="login">Sign In</router-link>
 ...
 <style scoped>
        @import 'si.css';
            ...
            *{box-sizing: border-box}input[type="submit"]{outline:none !important}
            ...
            .signup3{color:#dc0e00;text-decoration: none;}
       ...
       data(){
        ...
        methods:{
            ...
            signup(){
                ...
                var obj = {"email" : usrEmail,"password": pwd,"gender":gender,"fullName":name,"phoneNumber":num, "userType": "User"}; var res;
